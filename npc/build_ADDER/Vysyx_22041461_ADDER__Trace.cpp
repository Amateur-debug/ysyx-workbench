...
void Vysyx_22041461_ADDER___024root__traceChgSub0(Vysyx_22041461_ADDER___024root* vlSelf, VerilatedVcd* tracep);
...
void Vysyx_22041461_ADDER___024root__traceChgTop0(void* voidSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        Vysyx_22041461_ADDER___024root__traceChgSub0((&vlSymsp->TOP), tracep);
    }
}
...
void Vysyx_22041461_ADDER___024root__traceChgSub0(Vysyx_22041461_ADDER___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->chgQData(oldp+0,(vlSelf->in1),64);
        tracep->chgQData(oldp+2,(vlSelf->in2),64);
        tracep->chgQData(oldp+4,(vlSelf->sum),64);
        tracep->chgBit(oldp+6,(vlSelf->flag));
    }
}
