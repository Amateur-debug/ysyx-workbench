...
void Vysyx_22041461_CPU___024root__traceInitSub0(Vysyx_22041461_CPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declQuad(c+175,"ysyx_22041461_CPU ALU XOR_out", false,-1, 63,0);
        tracep->declQuad(c+177,"ysyx_22041461_CPU ALU OR_out", false,-1, 63,0);
        tracep->declQuad(c+179,"ysyx_22041461_CPU ALU SRL_out", false,-1, 63,0);
        ...
        tracep->declQuad(c+187,"ysyx_22041461_CPU ALU SLL sll", false,-1, 63,0);
        ...
        tracep->declQuad(c+175,"ysyx_22041461_CPU ALU XOR XOR_out", false,-1, 63,0);
        ...
        tracep->declQuad(c+177,"ysyx_22041461_CPU ALU OR OR_out", false,-1, 63,0);
...
void Vysyx_22041461_CPU___024root__traceFullSub0(Vysyx_22041461_CPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullQData(oldp+167,(vlSelf->ysyx_22041461_CPU__DOT__ALU__DOT__SLL_out),64);
        tracep->fullQData(oldp+169,(vlSelf->ysyx_22041461_CPU__DOT__ALU__DOT__SRA_out),64);
        ...
        tracep->fullQData(oldp+175,((vlSelf->ysyx_22041461_CPU__DOT__ALU__DOT__src1 
                                     ^ vlSelf->ysyx_22041461_CPU__DOT__ALU__DOT__src2)),64);
